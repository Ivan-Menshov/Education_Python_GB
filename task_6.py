class ScladOrgtexnic:
    ...
    def get_one_type_gadget_k_vallue(self, gadget, k):
        try:
            for _ in range(k):
                self.product_list.append(gadget)
        except TypeError:
            print('Количество единиц техники передается только в целых числах!!!')
...
sclad.get_one_type_gadget_k_vallue(my_printer_1, 'one')
sclad.get_one_type_gadget_k_vallue(my_printer_1, 2)
print(sclad.product_list)
